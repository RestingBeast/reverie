<img width="1920" height="1445" alt="4 1" src="https://github.com/user-attachments/assets/1820ecf6-a9ea-4dce-bd8d-7f93dfe27c44" /># Sonic-Self
...
5. The processed payload is sent to the Express backend, which calls the AI adapter and returns a personality summary.
6. The summary is saved to MongoDB with a unique `shareId`.
7. The user sees their personality card and can copy a public link at `/share/[shareId]`.
